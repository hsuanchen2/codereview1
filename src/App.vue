<template>
  ...
  >
    <div
      class="gdb-input__inner"
      :class="{ 'gdb-input__inner--focus': isFocus }"
    >
      ...
      <div class="gdb-input__input-wrapper">
        ...
        <div
          v-if="type === 'password'"
          class="gdb-input__password"
          @click="isShowPassword = !isShowPassword"
        >
          <span
            v-if="isShowPassword"
            class="gdb-input__password-icon material-icons-round"
            >visibility</span
          >
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    // 這邊命名可以更一致，例如例如 showPassword 和 focused。
